...
this,a=window.addEventListener?"addEventListener":"attachEvent";c[a]("attachEvent"===a?"onmessage":"message",function(a){if(a.source!==c){try{var d=JSON.parse(a.data)}catch(f){d=!1}a=d;d=a.constructor===Object?a.action:a;if(!d)return console.error(b.constructor.name+": Action mustn't be empty. Please, pass action like a string or like an object in key 'action'");if(b.registeredActions[d]){if(a.constructor===Object)return b.registeredActions[a.action](a.data);if("string"===typeof a)return b.registeredActions[d]()}else console.error(b.constructor.name+
